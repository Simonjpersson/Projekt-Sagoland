...
<!--Navigations Meny-->			
			...
			<section id="content">
				...
				<a href="FMDMK-4" id="content"><section class="left"><p></p></section></a>
								
				<a href="FMDMK-6" id="content"><section class="right"><p></p></section></a>


				<!--Dessa sektioner är vänster respektive höger innehåll i sagoboken-->
				<section id="contentleft">
					<p><img src="../static/sida5.png" alt="Flickan och katten förvandlas till prinsessor." class="storyimages"></p>	
				</section>
