...
<!--Navigations Meny-->			
			...
			<section id="content">
				...
				<a href="FMDMK-6" id="content"><section class="left"><p></p></section></a>
				...
				<section id="contentleft">
					<p><img src="../static/sida7.png" alt="Flickan och katten är plötsligt på en strand." class="storyimages"></p>	
				</section>
