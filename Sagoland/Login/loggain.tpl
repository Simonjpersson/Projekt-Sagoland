		...
		<div id="wrapper">
			...
			<section id="content">
				...
				<section id="contentleft">
					<h2>Hej!</h2>
					<p>
						För att kunna skriva en saga och publicera den måste du vara inloggad på Sagoland. Vill du endast testa att skriva en saga utan att publicera den så klicka <a href="/Write/write">här</a>.
					</p>
