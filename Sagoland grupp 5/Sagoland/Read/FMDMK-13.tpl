...
<!--Navigations Meny-->			
			...
			<section id="content">
				...
				<a href="FMDMK-12" id="content"><section class="left"><p></p></section></a>
								
				<a href="../read"><section class="right"><p></p></section></a>


				<!--Dessa sektioner är vänster respektive höger innehåll i sagoboken-->
				<section id="contentleft">
					<p><img src="../static/sida13.png" alt="Flickan med sin familj katt och hund." class="storyimages"></p>	
				</section>
