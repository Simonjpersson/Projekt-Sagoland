...
<!--Navigations Meny-->			
			...
			<section id="content">
				...
				<a href="FMDMK-3" id="content"><section class="left"><p></p></section></a>
								
				<a href="FMDMK-5" id="content"><section class="right"><p></p></section></a>


				<!--Dessa sektioner är vänster respektive höger innehåll i sagoboken-->
				<section id="contentleft">
					<p><img src="../static/sida4.png" alt="Flickan börjar rita på väggen med sina magiska kritor." class="storyimages"></p>	
				</section>
