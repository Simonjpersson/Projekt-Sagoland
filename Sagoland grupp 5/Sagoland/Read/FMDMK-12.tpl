...
<!--Navigations Meny-->			
			...
			<section id="content">
				...
				<a href="FMDMK-11" id="ontent"><section class="left"><p></p></section></a>
								
				<a href="FMDMK-13" id="content"><section class="right"><p></p></section></a>


				<!--Dessa sektioner är vänster respektive höger innehåll i sagoboken-->
				<section id="contentleft">
					<p><img src="../static/sida12.png" alt="Flickan ritar hela familjen." class="storyimages"></p>	
				</section>
