...
<!--Navigations Meny-->			
			...
			<section id="content">
				...
				<a href="FMDMK-10" id="content"><section class="left"><p></p></section></a>
								
				<a href="FMDMK-12" id="content"><section class="right"><p></p></section></a>


				<!--Dessa sektioner är vänster respektive höger innehåll i sagoboken-->
				<section id="contentleft">
					<p><img src="../static/sida11.png" alt="Flickan är chockad för att mamma ser att hon ritat på tapeten." class="storyimages"></p>	
				</section>
