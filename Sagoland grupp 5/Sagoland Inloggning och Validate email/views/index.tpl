		...
		<div id="wrapper">
			...
			<div id='cssmenu'>
				<ul> 	
					...
					<li class='active'><a href="/index/">Skriv Saga</a></li>
			...
			<section id="content">
				...
				<section id="contentleft">
					<h2>Hej!</h2>
					<p>
						För att kunna skriva en saga och publicera den måste du vara inloggad på Sagoland. Vill du endast testa att skriva en saga utan att publicera den så klicka <a href="write/write.html">här</a>.
					</p>
